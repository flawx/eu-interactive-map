export type Messages = {
  ...
  legend: {
    ...
    groupCultureAttractions: string;
    groupNatureProtected: string;
    natura2000: string;
    ...
    touristInformationOffices: string;
    touristInformationOfficesDescription: string;
    diplomaticMissions: string;
    diplomaticMissionsDescription: string;
    visitorSafetyAssistance: string;
    visitorSafetyAssistanceDescription: string;
    emergency112Note: string;
  ...
  diplomaticMissionPanel: {
    badge: string;
    missionType: string;
    missionTypeEmbassy: string;
    missionTypeConsulate: string;
    missionTypePermanentRepresentation: string;
    missionTypeOther: string;
    ...
    emergencyPhoneUnavailable: string;
    source: string;
    close: string;
    coordinatesApproximateNote: string;
  };
  visitorSafetyPanel: {
    badge: string;
    typeTouristPolice: string;
    typeEmergencyAssistance: string;
    typeFirstAidPost: string;
    typeMountainRescue: string;
    typeBeachRescue: string;
    typeVisitorSafetyOffice: string;
    city: string;
    address: string;
    phone: string;
    openingHours: string;
  ...
  natura2000Panel: {
    ...
    designationSpa: string;
    designationSac: string;
    designationSci: string;
    designationPsci: string;
    designationUnknown: string;
    country: string;
    areaHectares: string;
    areaUnavailable: string;
    source: string;
  ...
  beachResortPanel: {
    ...
    municipality: string;
    coastalType: string;
    coastalTypeAtlantic: string;
    coastalTypeMediterranean: string;
    coastalTypeAdriatic: string;
    coastalTypeAegean: string;
    coastalTypeBaltic: string;
    coastalTypeNorthSea: string;
    officialWebsite: string;
    source: string;
    close: string;
  };
  outdoorRoutePanel: {
    badge: string;
    routeTypeHiking: string;
    routeTypeCycling: string;
    routeTypeRunning: string;
    routeCode: string;
    distance: string;
