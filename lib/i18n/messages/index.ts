...
export function getMessages(locale: Locale): Messages {
  ...
  return {
    ...
    legend: {
      ...
      groupRoadTraffic: alerts.roadTrafficGroup,
      liveTrafficFlow: alerts.liveTrafficFlow,
      roadTrafficIncidents: alerts.roadTrafficIncidents,
      trafficAccidents: alerts.trafficAccidents,
      trafficMajorJams: alerts.trafficMajorJams,
      trafficBrokenVehicles: alerts.trafficBrokenVehicles,
      trafficHazards: alerts.trafficHazards,
      trafficRoadWeather: alerts.trafficRoadWeather,
      trafficOtherIncidents: alerts.trafficOtherIncidents,
      roadClosuresRestrictions: alerts.roadClosuresRestrictions,
      trafficRoadClosures: alerts.trafficRoadClosures,
      trafficLaneClosures: alerts.trafficLaneClosures,
      trafficRestrictions: alerts.trafficRestrictions,
      roadworks: alerts.roadworks,
      trafficActiveRoadworks: alerts.trafficActiveRoadworks,
      trafficPlannedRoadworks: alerts.trafficPlannedRoadworks,
    },
    search: {
      ...en.search,
      ...localized.search,
