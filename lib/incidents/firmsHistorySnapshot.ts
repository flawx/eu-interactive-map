...
export type FirmsHistorySnapshotRow = {
  incident_id: string;
...
export function validateFirmsHistorySnapshot(
  value: unknown,
...
export function rowToFirmsHistorySnapshot(
  row: FirmsHistorySnapshotRow,
): FirmsIncidentSnapshot | null {
...
export function firmsHistorySnapshotToRow(
  snapshot: FirmsIncidentSnapshot,
): FirmsHistorySnapshotRow {
  return {
    ...
    period_start: snapshot.periodStart ?? null,
    period_end: snapshot.periodEnd ?? null,
