      ...
      <header className="sticky top-0 z-[5] shrink-0 border-b border-[var(--map-ui-border)] bg-[var(--map-ui-surface)] px-4 py-3 backdrop-blur-md">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-[11px] text-[var(--map-ui-muted)]">{shortName}</p>
      ...
      <div className="min-h-0 flex-1 overflow-x-hidden overflow-y-auto px-4 py-3">
        ...
        <section className="mb-4">
          ...
          {institution.id === "european-parliament" ? (
            <p className="mb-2 text-[11px] leading-relaxed text-[var(--map-ui-muted)]">
                ...
                >
                  <div className="flex items-start gap-2">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {site.address ? (
                        <p className="mt-1 text-[11px] leading-snug text-[var(--map-ui-muted)]">
                          {site.address}
                        </p>
                      ) : null}
                      {site.sharedSite ? (
