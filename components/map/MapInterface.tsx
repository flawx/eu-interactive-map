...
import Wifi4EuPanel from "@/components/travel/Wifi4EuPanel";
import TouristOfficePanel from "@/components/travel/TouristOfficePanel";
...
export default function MapInterface() {
  ...
  const [selectedInstitutionSiteId, setSelectedInstitutionSiteId] = useState<
    string | null
  >(null);
  const [showEuBodiesAgencies, setShowEuBodiesAgencies] = useState(
    DEFAULT_MAP_LAYER_PREFERENCES.euBodiesAgencies,
  );
  const [selectedEuBodyAgencyId, setSelectedEuBodyAgencyId] = useState<
    string | null
  >(null);
  const [showInternationalOrganisations, setShowInternationalOrganisations] =
    useState(DEFAULT_MAP_LAYER_PREFERENCES.internationalOrganisations);
  const [
    selectedInternationalOrganisationId,
    setSelectedInternationalOrganisationId,
  ] = useState<string | null>(null);
  const [
    showEuropeanCapitalsOfCulture,
    setShowEuropeanCapitalsOfCulture,
  ...
  const [showWifi4Eu, setShowWifi4Eu] = useState(
    DEFAULT_MAP_LAYER_PREFERENCES.wifi4eu,
  );
  ...
  const [selectedTouristOfficeId, setSelectedTouristOfficeId] = useState<
    string | null
  >(null);
  const [showDiplomaticMissions, setShowDiplomaticMissions] = useState(
    DEFAULT_MAP_LAYER_PREFERENCES.diplomaticMissions,
  );
  const [selectedDiplomaticMissionId, setSelectedDiplomaticMissionId] =
    useState<string | null>(null);
  const [showVisitorSafetyAssistance, setShowVisitorSafetyAssistance] =
    useState(DEFAULT_MAP_LAYER_PREFERENCES.visitorSafetyAssistance);
  const [selectedVisitorSafetyLocationId, setSelectedVisitorSafetyLocationId] =
    useState<string | null>(null);
  const [showNatura2000, setShowNatura2000] = useState(
    DEFAULT_MAP_LAYER_PREFERENCES.natura2000,
  );
  ...
  const [showMajorHikingRoutes, setShowMajorHikingRoutes] = useState(
    DEFAULT_MAP_LAYER_PREFERENCES.majorHikingRoutes,
  );
  ...
  const [selectedOutdoorRouteId, setSelectedOutdoorRouteId] = useState<
    string | null
  >(null);
  const [selectedOutdoorRouteClickPoint, setSelectedOutdoorRouteClickPoint] =
  ...
  useEffect(() => {
    ...
    saveMapLayerPreferences({
      ...
      euBodiesAgencies: showEuBodiesAgencies,
      internationalOrganisations: showInternationalOrganisations,
      europeanCapitalsOfCulture: showEuropeanCapitalsOfCulture,
      ...
      wifi4eu: showWifi4Eu,
      touristInformationOffices: showTouristInformationOffices,
  ...
  const handleLegendPreferenceToggle = (
    ...
    > = {
      ...
      wifi4eu: setShowWifi4Eu,
      touristInformationOffices: setShowTouristInformationOffices,
  ...
  const handleLegendLayersReset = () => {
    ...
    setShowWifi4Eu(defaults.wifi4eu);
    setShowTouristInformationOffices(defaults.touristInformationOffices);
  ...
  const clearEuBodyAgencySelection = () => {
    setSelectedEuBodyAgencyId(null);
  };

  const clearInternationalOrganisationSelection = () => {
    setSelectedInternationalOrganisationId(null);
  };

  const clearCapitalOfCultureSelection = () => {
    setSelectedCapitalOfCultureId(null);
  };
  ...
  const clearTouristOfficeSelection = () => {
    setSelectedTouristOfficeId(null);
  };

  const clearDiplomaticMissionSelection = () => {
    setSelectedDiplomaticMissionId(null);
  };

  const clearVisitorSafetySelection = () => {
    setSelectedVisitorSafetyLocationId(null);
  };

  const clearTravelVisitorServicesSelection = () => {
    clearWifi4EuSelection();
    clearTouristOfficeSelection();
    clearDiplomaticMissionSelection();
    clearVisitorSafetySelection();
  };

  const clearNatura2000Selection = () => {
  ...
  const clearOutdoorRouteSelection = () => {
    setSelectedOutdoorRouteId(null);
    setSelectedOutdoorRouteClickPoint(null);
  };
  ...
  const handleCountrySelect = (countryCode: string | null) => {
    ...
    clearTravelNatureBathingSelection();
  ...
  const handleEuBodyAgencySelect = (agencyId: string | null) => {
    setSelectedWildfireId(null);
    setSelectedEffisBurnedArea(null);
    setSelectedCountryCode(null);
    setSelectedCapitalId(null);
    ...
    if (agencyId) {
      setShowEuBodiesAgencies(true);
      const agency = getEuBodyAgencyById(agencyId);
      if (agency) {
        requestFocus({
          kind: "point",
  ...
  const handleInternationalOrganisationSelect = (
    ...
    if (organisationId) {
      setShowInternationalOrganisations(true);
      const organisation = getInternationalOrganisationById(organisationId);
      if (organisation) {
        requestFocus({
          kind: "point",
  ...
  const handleCapitalOfCultureSelect = (capitalOfCultureId: string | null) => {
    setSelectedWildfireId(null);
    setSelectedEffisBurnedArea(null);
    setSelectedCountryCode(null);
    setSelectedCapitalId(null);
    ...
    if (capitalOfCultureId) {
      setShowEuropeanCapitalsOfCulture(true);
      const capital = getEuropeanCapitalOfCultureById(capitalOfCultureId);
      if (capital) {
        requestFocus({
          kind: "point",
          longitude: capital.longitude,
  ...
  const handleWifi4EuHotspotSelect = (hotspotId: string | null) => {
    setSelectedWildfireId(null);
    setSelectedEffisBurnedArea(null);
    setSelectedCountryCode(null);
    setSelectedCapitalId(null);
  ...
  const handleTouristOfficeSelect = (officeId: string | null) => {
    setSelectedWildfireId(null);
    setSelectedEffisBurnedArea(null);
    setSelectedCountryCode(null);
    setSelectedCapitalId(null);
    ...
    clearVisitorSafetySelection();
    clearTemporaryPlace();
    setSelectedTouristOfficeId(officeId);

    if (officeId) {
      setShowTouristInformationOffices(true);
      const office = getTouristOfficeById(officeId);
      if (office) {
        requestFocus({
          kind: "point",
  ...
  const handleDiplomaticMissionSelect = (missionId: string | null) => {
    setSelectedWildfireId(null);
    setSelectedEffisBurnedArea(null);
    setSelectedCountryCode(null);
    setSelectedCapitalId(null);
    ...
    clearVisitorSafetySelection();
    clearTemporaryPlace();
    setSelectedDiplomaticMissionId(missionId);

    if (missionId) {
      setShowDiplomaticMissions(true);
      const mission = getDiplomaticMissionById(missionId);
      if (mission) {
        requestFocus({
          kind: "point",
  ...
  const handleVisitorSafetySelect = (locationId: string | null) => {
    setSelectedWildfireId(null);
    setSelectedEffisBurnedArea(null);
    setSelectedCountryCode(null);
    setSelectedCapitalId(null);
    ...
    clearDiplomaticMissionSelection();
    clearTemporaryPlace();
    setSelectedVisitorSafetyLocationId(locationId);

    if (locationId) {
      setShowVisitorSafetyAssistance(true);
      const location = getVisitorSafetyLocationById(locationId);
      if (location) {
        requestFocus({
          kind: "point",
  ...
  const handleNatura2000SiteSelect = (site: Natura2000Site | null) => {
    setSelectedWildfireId(null);
    setSelectedEffisBurnedArea(null);
    setSelectedCountryCode(null);
    setSelectedCapitalId(null);
    ...
    clearOutdoorRouteSelection();
    clearTemporaryPlace();
    setSelectedNatura2000Site(site);

    if (site) {
      setShowNatura2000(true);
      requestFocus({
        kind: "point",
  ...
  const handleBeachSelect = (beachId: string | null) => {
    setSelectedWildfireId(null);
    setSelectedEffisBurnedArea(null);
    setSelectedCountryCode(null);
    setSelectedCapitalId(null);
    ...
    if (beachId) {
      setShowMajorBeachesSeasideResorts(true);
      const beach = getMajorBeachById(beachId);
      if (beach) {
        requestFocus({
          kind: "point",
  ...
  const handleOutdoorRouteSelect = (
    routeId: string | null,
    ...
    setSelectedOutdoorRouteClickPoint(clickPoint ?? null);
  ...
  return (
    ...
    clearTravelNatureBathingSelection();
        ...
        {selectedEuBodyAgencyId &&
          ...
          !selectedCountryCode && (
            <EuBodyAgencyPanel
              agencyId={selectedEuBodyAgencyId}
              locale={locale}
              onClose={clearEuBodyAgencySelection}
              onRouteToPlace={handleRouteToPlace}
            />
          )}
        ...
        {selectedInternationalOrganisationId &&
          ...
          !selectedCountryCode && (
            <InternationalOrganisationPanel
              organisationId={selectedInternationalOrganisationId}
              locale={locale}
              onClose={clearInternationalOrganisationSelection}
              onRouteToPlace={handleRouteToPlace}
            />
          )}
        ...
        {selectedTouristOfficeId &&
          ...
          !selectedCountryCode && (
            <TouristOfficePanel
              officeId={selectedTouristOfficeId}
              locale={locale}
              onClose={clearTouristOfficeSelection}
              onRouteToPlace={handleRouteToPlace}
            />
          )}
        ...
        {selectedDiplomaticMissionId &&
          ...
          !selectedCountryCode && (
            <DiplomaticMissionPanel
              missionId={selectedDiplomaticMissionId}
              locale={locale}
              onClose={clearDiplomaticMissionSelection}
              onRouteToPlace={handleRouteToPlace}
            />
          )}
        ...
        {selectedVisitorSafetyLocationId &&
          ...
          !selectedCountryCode && (
            <VisitorSafetyPanel
              locationId={selectedVisitorSafetyLocationId}
              locale={locale}
              onClose={clearVisitorSafetySelection}
              onRouteToPlace={handleRouteToPlace}
            />
          )}
        ...
        {selectedOutdoorRouteId &&
          ...
          !selectedCountryCode && (
            <OutdoorRoutePanel
              routeId={selectedOutdoorRouteId}
              referencePoint={selectedOutdoorRouteClickPoint}
              locale={locale}
              onClose={clearOutdoorRouteSelection}
              onRouteToPlace={handleRouteToPlace}
            />
          )}
