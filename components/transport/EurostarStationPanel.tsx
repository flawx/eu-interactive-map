      ...
      <div className="min-h-0 flex-1 overflow-x-hidden overflow-y-auto px-4 py-3">
        {loading && (
          <div className="space-y-3" aria-busy="true" aria-label={tp.loadingDetails}>
            ...
            <div className="mt-2 space-y-2">
              <div className="h-8 animate-pulse rounded-lg bg-[var(--map-ui-surface-muted)]" />
              <div className="h-8 animate-pulse rounded-lg bg-[var(--map-ui-surface-muted)]" />
            </div>
          </div>
        )}
        ...
        {!loading && !error && (
          <div className="space-y-5">
            ...
            <section>
              <h3 className="mb-1 flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-[var(--map-ui-muted)]">
            ...
            <section>
              <h3 className="mb-2 text-xs font-semibold uppercase tracking-wide text-[var(--map-ui-muted)]">
                {tp.directDestinations}
              </h3>
              <ul className="space-y-1.5 text-sm text-[var(--map-ui-text)]">
                {destinations.map((dest) => (
                  <li
                    key={dest.stationId}
                    className="flex items-center justify-between gap-2 rounded-lg border border-[var(--map-ui-border)] bg-[var(--map-ui-surface-muted)] px-2.5 py-1.5"
                  >
                    <span>
                      {dest.name}
                      <span className="text-[var(--map-ui-muted)]"> · {dest.city}</span>
                    </span>
                    <span className="text-[11px] font-medium uppercase text-[var(--map-ui-muted)]">
              ...
              <p className="mt-2 text-xs text-[var(--map-ui-muted)]">
            ...
            {(details?.recommendedArrivalInfo ||
              ...
              <section>
                <h3 className="mb-1 text-xs font-semibold uppercase tracking-wide text-[var(--map-ui-muted)]">
                  {tp.practicalInfo}
                </h3>
                {details.recommendedArrivalInfo ? (
